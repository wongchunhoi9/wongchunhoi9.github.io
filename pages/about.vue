...
.profile-session .row .col {
    background-color: rgba(241, 212, 180, 0.139);
    border-block-color: rgb(17, 26, 29);
    border-style: solid;
    border-width: 1px;
    padding-block: 5px;
